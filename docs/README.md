...
> التطبيق: `apps/web` · **قبل كل جلسة:** `git pull origin main`
...
1i. ملخص البوابات في [production-work-plan.md](./production-work-plan.md) — **MVP 0→9 مغلق** · المرحلة 10 ✓ · المرحلة 11 ✓ · المرحلة 12 قيد الاختبار
...
1l. [phase-12-progress.md](./phase-12-progress.md) — معرض / FAQ / من نحن (بانتظار الاختبار اليدوي)
