...
## المرحلة 15 — صلاحيات وجلسة (= موجة B) · **التالي**

### الهدف
فريق متعدد الأدوار بأمان: ليس كل موظف أدمن كامل؛ الجلسة تحترم التعطيل؛ الـ Actions والـ API محميّان.

### الهيكل / المطلوب
| # | المشكلة | المطلوب |
|---|---------|---------|
| 15.1 / B1 | أي موظف = أدمن كامل | دور في الجلسة + `requireAdmin()` / صلاحيات حسب الشاشة |
...
| 15.5 / B5 | موظفين/كلمات مرور بلا قيد دور | مدير فقط يرفع صلاحيات ويعيد تعيين كلمات المرور |

### مخرجات إلزامية
- [ ] البنود 15.1–15.5 منفَّذة ومختبرة
- [ ] لا أزرار صامتة
...
| # | الاختبار | نتيجة (✓/✗) |
|---|----------|--------------|
| 15.1 | حساب غير مدير لا يدخل إعدادات / موظفين (حسب الصلاحية) | |
| 15.2 | تعطيل مستخدم يقطع الوصول فوراً (بعد طلب جديد) | |
| 15.3 | Server Action بدون جلسة مرفوض | |
| 15.4 | طلب `/api/admin/*` بدون كوكي = 401 | |
| 15.5 | غير المدير لا يعيد تعيين كلمة مرور / لا يرفع صلاحيات | |

**توقيع:** ________  **التاريخ:** ________  **انتقال؟** ________  
**إشعار واتساب أُرسل؟** ________

مرجع تفصيلي: [quality-gaps-map.md](./quality-gaps-map.md) § موجة B
