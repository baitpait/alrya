...
| 15 | صلاحيات وجلسة (= موجة B) | ✓ **أُغلقت 2026-08-18** |
| 16 | توسّع وأداء (= موجة C) | **التالي للمبرمج** |
...
| 15 | صلاحيات وجلسة | ✓ | كانت موجة B |
| 16 | توسّع وأداء | **التالي** | كانت موجة C |
...
## المرحلة 15 — صلاحيات وجلسة (= موجة B) · **أُغلقت 2026-08-18**
...
### مخرجات إلزامية
- [x] البنود 15.0–15.5 منفَّذة ومختبرة
- [x] اختبارات L1–L5 في [pm-login-admin-only.md](./pm-login-admin-only.md)
- [x] لا أزرار صامتة · لغة عربية بلا مصطلحات تقنية
- [x] بوابة اختبار يدوي موقعة + `pm-notify` gate
...
**توقيع:** نهلة البستنجي  **التاريخ:** 2026-08-18  **انتقال؟** نعم — إلى المرحلة 16  
**إشعار واتساب أُرسل؟** نعم (`gate --id 15 --pass true`)

مرجع تفصيلي: [quality-gaps-map.md](./quality-gaps-map.md) § موجة B · [pm-login-admin-only.md](./pm-login-admin-only.md) · [phase-15-progress.md](./phase-15-progress.md)
...
> **13:** قرار منتج مغلق. **14:** أمن ✓. **15:** صلاحيات ✓. **التالي للمبرمج: 16** (توسّع وأداء).
...
| 15 | صلاحيات وجلسة | 2026-08-18 | نهلة البستنجي | ✓ |
| 16 | توسّع وأداء | — | — | **التالي** |
