...
> تاريخ التحليل: 2026-08-08 · **تحديث حي:** 2026-08-12  
...
>  
> **تحليل هيكلي محدّث وكامل (قوائم + SMS/OTP + طاقم):** [wameed-full-architecture.md](./wameed-full-architecture.md)  
> **دخول الديمو للاختبار:** [wameed-demo-qa.md](./wameed-demo-qa.md)  
...
| كلمة مرور الديمو (اختبار) | `Test@123` — انظر [wameed-demo-qa.md](./wameed-demo-qa.md) |
...
### 4.8 مناسباتي (Employee Event Services) — طاقم التغطية

شاشة **الموظف المعيَّن كطاقم** على خدمة مناسبة (ليس الزبون):

| الزبون | الهاتف | المشرف | المناسبة | الراتب | المكافئة | الوظيفة | الأيام الباقية |

مثال منطقي لاستوديو الراية: عرس **أحمد** يغطيه **محمد** و **خليل** → تعيينان على نفس `EventService`.

مثال من وميض: مصور معيّن على «حنا» براتب 200.

تفاصيل الدخول والاختبار: [wameed-demo-qa.md](./wameed-demo-qa.md)
...
### 4.13 الرسائل القصيرة (SMS) — وتوضيح OTP

- رصيد رسائل على الداشبورد (وقت التحليل: **0**)
- قائمة `/ControlPanel/SMS`: الزبون | الهاتف | الرسالة | الحالة | التاريخ
- تعريفات: `SMSTemplate` — مثال حي: `شكر` = «شكرا لإختيارك ستوديو الوميض»
- من **خدمات المناسبات**: زر «إرسال رسالة» للزبون
- من **الموظفين**: زر «إرسال رسالة»

**OTP:** لم تُرَ شاشة OTP مستقلة في ControlPanel أثناء إعادة التحليل 2026-08-12.  
التفاصيل والمقارنة مع الراية: [wameed-full-architecture.md](./wameed-full-architecture.md) §5.
